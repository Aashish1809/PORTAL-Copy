...
public class sendpushondismissevent extends AppCompatActivity  {
    ...
    private static final String KEY_PIN = "title";
    private EditText editTextTitle, editTextMessage, editTextImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sendpushondismissevent);
        ...
        pin=d.getString("idpass");
        editTextTitle.setText("Dismissal Message");
        editTextMessage.setText("Event placed has been Dismissed");
        ...
        editTextMessage.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus && TextUtils.isEmpty(editTextMessage.getText().toString())){
                    editTextMessage.setText("Event placed has been Dismissed");
                } else if (hasFocus && editTextMessage.getText().toString().equals("Event placed has been Dismissed")){
    ...
    private void sendSinglePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPoints.URL_SEND_SINGLE_PUSH_TO_EM,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(sendpushondismissevent.this, response, Toast.LENGTH_LONG).show();
                        Deletion();
                    ...
                    class Delete extends AsyncTask<String,String,String> {
                        ...
                        public void onPreExecute() {
                            super.onPreExecute();
                            pDialog = new ProgressDialog(sendpushondismissevent.this);
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    if (success == 1) {
                                        ...
                                        Toast.makeText(sendpushondismissevent.this,
