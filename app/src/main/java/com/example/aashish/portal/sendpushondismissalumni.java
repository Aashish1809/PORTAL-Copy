...
public class sendpushondismissalumni extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sendpushondismissalumni);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPoints.URL_SEND_SINGLE_PUSH_TO_ALUMNI,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(sendpushondismissalumni.this, response, Toast.LENGTH_LONG).show();
                        Deletion();
                    ...
                    class Delete extends AsyncTask<String,String,String> {
                        ...
                        public void onPreExecute() {
                            super.onPreExecute();
                            pDialog = new ProgressDialog(sendpushondismissalumni.this);
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    if (success == 1) {
                                        ...
                                        Toast.makeText(sendpushondismissalumni.this,
