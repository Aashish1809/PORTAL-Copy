...
public class forgotpassworda extends AppCompatActivity {
    String c,a,b;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forgotpassworda);
    ...
    private class Update extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            httpParams.put(KEY_PIN, c);
            httpParams.put(KEY_PASSWORD, a);
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    EndPoints.BASE_URL + "updatepassa.php", "POST", httpParams);
            try {
        ...
        protected void onPostExecute(String result) {
            runOnUiThread(new Runnable() {
                public void run() {
                    if (success == 1) {
                        Toast.makeText(forgotpassworda.this,
