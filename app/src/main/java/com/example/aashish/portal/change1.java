...
public class change1 extends Activity {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    if (CheckNetworkStatus.isNetworkAvailable(getApplicationContext())) {
                        ...
                        Toast.makeText(change1.this, "UNABLE TO CONNECT...!",
    ...
    private class Update extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            p = new ProgressDialog(change1.this);
        ...
        protected String doInBackground(String... params) {
            ...
            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                    EndPoints.BASE_URL + "change1.php", "POST", httpParams);
            try {
