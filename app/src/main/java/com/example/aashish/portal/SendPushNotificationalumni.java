...
public class SendPushNotificationalumni extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_push_notificationalumni);
        ...
        editTextTitle.setText("Verification Message");
        editTextMessage.setText(pin+", has been Verified");
        editTextTitle.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus && TextUtils.isEmpty(editTextTitle.getText().toString())){
                    editTextTitle.setText("Verification Message");
                } else if (hasFocus && editTextTitle.getText().toString().equals("Verification Message")){
        ...
        editTextMessage.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if(!hasFocus && TextUtils.isEmpty(editTextMessage.getText().toString())){
                    editTextMessage.setText(pin+", has been Verified");
                } else if (hasFocus && editTextMessage.getText().toString().equals(pin+", has been Verified")){
    ...
    private void sendSinglePush() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, EndPoints.URL_SEND_SINGLE_PUSH_TO_ALUMNI,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Toast.makeText(SendPushNotificationalumni.this, response, Toast.LENGTH_LONG).show();
                        Deletion();
                    ...
                    class Delete extends AsyncTask<String,String,String> {
                        ...
                        public void onPreExecute() {
                            super.onPreExecute();
                            pDialog = new ProgressDialog(SendPushNotificationalumni.this);
                        ...
                        public String doInBackground(String... params) {
                            ...
                            JSONObject jsonObject = httpJsonParser.makeHttpRequest(
                                    EndPoints.BASE_URL + "Delete_details2.php", "POST", httpParams);
                            try {
                        ...
                        public void onPostExecute(String result) {
                            ...
                            runOnUiThread(new Runnable() {
                                public void run() {
                                    if (success == 1) {
                                        Toast.makeText(SendPushNotificationalumni.this,
